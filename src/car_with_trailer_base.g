...
arm_(arm) { Q:<t(.25 0 0)> , shape:ssBox, size:[.5 .05 .5 0.04] color:[.3 .3 .3 .8] }

trailer(arm_) { Q:<t(.25 0 0)> , shape:ssBox, size:[.3 .25 .5 0.04] color:[.3 .3 .3 .5] }
...
robot_shape(robot){ shape:ssBox, Q:<t(0 0 0 )> , size:[.5 .25 .5 .04],color:[.1 .1 .2 .4]   }
