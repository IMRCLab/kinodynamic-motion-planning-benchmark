...
BOOST_AUTO_TEST_CASE(test_jacobians) {
...

  {
    ...
    gen_args.only_contour_last = false;
    gen_args.alpha_refs = alpha_refs;
    gen_args.cost_alpha_multis = cost_alpha_multis;
...
BOOST_AUTO_TEST_CASE(contour_park_raw) {
  ...
  opti_params.regularize_wrt_init_guess = 0;
  ...
  opti_params.num_steps_to_move = 10;
  opti_params.num_steps_to_optimize = 40;
...
BOOST_AUTO_TEST_CASE(parallel_small_step_good_init_guess) {
  ...
  opti_params.control_bounds = 1;
  opti_params.use_warmstart = 1;
  opti_params.num_steps_to_move = 2;
  opti_params.num_steps_to_optimize = 35;
  opti_params.smooth_traj = 1;
...
BOOST_AUTO_TEST_CASE(parallel_bad_init_guess) {
  ...
  opti_params.control_bounds = 1;
  opti_params.use_warmstart = 1;
  opti_params.num_steps_to_move = 5;
  opti_params.num_steps_to_optimize = 30;
  opti_params.smooth_traj = 1;
...
BOOST_AUTO_TEST_CASE(kink_mpcc) {
  ...
  opti_params.control_bounds = 1;
  opti_params.use_warmstart = 1;
  opti_params.num_steps_to_move = 20;
  opti_params.num_steps_to_optimize = 40;
  opti_params.weight_goal = 100;
  opti_params.k_linear = 20;
  opti_params.k_contour = 10;
